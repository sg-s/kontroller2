...
% 
% created by Srinivas Gorur-Shandilya at 5:31 , 08 July 2015. Contact me at http://srinivas.gs/contact/
% 
...
if floor(n/2)*2 == n
    ...
    error('Kontroller2/ConfigureInputChannels error 74: Odd number of channels, cannot handle this')
end

setappdata(handles.f1,'InputChannelNames',InputChannelNames);
setappdata(handles.ConfigureInputsFigure,'handles',handles);

% add these variable names to the data structure
data = getappdata(handles.f1,'data');
