...
if ~figure_exists
    ...
    for i = 1:noutputs
        ...
        k.handles.manual_control.slider_lb(i) = uicontrol(k.handles.manual_control.fig_handle,'style','edit','String','0','Units','normalized','Position',[.1+x .17 w .08],'Callback',@k.changeSliderBounds);
